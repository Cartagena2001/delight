        ...
        <body>
                ...
                <button type="button" class="btn" id="botones"><i class="fas fa-shopping-cart"></i> <a href="../../views/cliente/carrito.php" style="text-decoration:none;color:#03658C;">Carrito </a></button>
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                      ...
                      <a class="dropdown-item" href="../../views/cliente/login.php" data-toggle="modal" data-target="#exampleModal">Cerrar sesión</a>
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="../../views/cliente/login.php" class="btn" style="background-color: #138496;color:white;">Salir</a>
                        </div>
                      </div>
                    </div>
                  </div>
