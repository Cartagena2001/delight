...
<body>
    ...
    <div class="contaniner">
        ...
        <a href="#" class="btn"><i class="fas fa-edit" style="color: #03658C"></i> Editar contenido</a>
        <a href="index.php" class="btn"><i class="fas fa-columns" style="color: #03658C"></i></i> Regresar a Dashborad</a>
        </div>
    </div>
