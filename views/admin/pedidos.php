        ...
        <form method="post" id="save-form"  name="save-form" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="form-group">
                        <input id="id_cliente" name="id_cliente" type="text" class="form-control" placeholder="Cliente" required>
                </div>                
                <div class="form-group">
                        <input  id="id_cupon" name="id_cupon" type="text" class="form-control" placeholder="Cupon" required>
                </div>
                <div class="form-group">
                        <input id="id_detalle_pedido" name="id_detalle_pedido" type="text" class="form-control" placeholder="Detalle pedido" required>
                </div>
                <div class="form-group">
