    ...
    <div class="row">
        ...
        <form method="post" id="search-categorias">
            <div class="input-field col s6 m6"> 
                ...
                <a href="../../core/reports/dashboard/categorias.php" target="_blank" class="btn btn-primary ml-4" data-tooltip="Reporte de productos por categoría">Generar reporte</a>
            </div>
        </form>
        </div>
<div class="container">
